<template>
  ...
  >
    <fieldset>
      ...
      <div class="icon">
        <label :class="{ float: name }" class="cd-label" for="name">
          Name
        </label>
      ...
      <div class="icon">
        <label :class="{ float: company }" class="cd-label" for="company">
          Company
        </label>
      ...
      <div class="icon">
        <label :class="{ float: email }" class="cd-label" for="email">
          Email
        </label>
...
.cd-form [required].user {
  background: url('/img/contact/cd-icon-user.svg') no-repeat 16px center,
    url('/img/contact/cd-required.svg') no-repeat top right;
}
