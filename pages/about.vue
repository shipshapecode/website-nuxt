                  ...
                  <div class="space-y-4">
                    <div class="aspect-w-3 aspect-h-2">
                      <img
                        ...
                        alt="Image of Chuck Carpenter"
                      />
                    </div>

                    <div class="space-y-2">
                      <div class="text-lg leading-6 font-medium space-y-1">
                        <h3>Chuck Carpenter</h3>
                ...
                <li>
                  <div class="space-y-4">
                    <div class="aspect-w-3 aspect-h-2">
                      <img
                        class="object-cover shadow-lg rounded-lg"
                        src="/img/blog/authors/rob.jpg"
                        alt="Headshot of Rob Cary"
                      />
                    </div>
                    ...
                    <div class="space-y-2">
                      <div class="text-lg leading-6 font-medium space-y-1">
                        <h3>Rob Cary</h3>
                        <p class="text-indigo-600">Senior Software Engineer</p>
                      </div>
                      <ul class="flex space-x-5">
                        <li>
                          <a href="#" class="text-gray-400 hover:text-gray-500">
                ...
                <li>
                  <div class="space-y-4">
                    <div class="aspect-w-3 aspect-h-2">
                      <img
                        class="object-cover shadow-lg rounded-lg"
                        src="/img/blog/authors/jared.jpg"
                        alt=""
                      />
                    </div>
                ...
                <li>
                  <div class="space-y-4">
                    <div class="aspect-w-3 aspect-h-2">
                      <img
                        class="object-cover shadow-lg rounded-lg"
                        src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixqx=ELhezQOata&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80"
                        alt=""
                      />
                    </div>
